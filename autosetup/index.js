...
(async () => {
    ...
    await axios.post('http://' + targetIP + ':' + prowlarrPort + '/api/v1/applications', prowlarrAddRadarr, { headers: prowlarrHeader })
        .then(function (response) {
            console.log('[Prowlarr] Radarr added');
        })
        .catch(function (error) {
            console.log('[Prowlarr] Radarr already added');
        });
    ...
    await axios.post('http://' + targetIP + ':' + prowlarrPort + '/api/v1/applications', prowlarrAddSonarr, { headers: prowlarrHeader })
        .then(function (response) {
            console.log('[Prowlarr] Sonarr added');
        })
        .catch(function (error) {
            console.log('[Prowlarr] Sonarr already added');
        });
    ...
    await axios.post('http://' + targetIP + ':' + prowlarrPort + '/api/v1/indexer', prowlarrAddT911, { headers: prowlarrHeader })
        .then(function (response) {
            console.log('[Prowlarr] Torrent911 added');
        })
        .catch(function (error) {
            console.log('[Prowlarr] Torrent911 already added');
        });
    ...
    await axios.post('http://' + targetIP + ':' + prowlarrPort + '/api/v1/indexer', prowlarrAddTbb, { headers: prowlarrHeader })
        .then(function (response) {
            console.log('[Prowlarr] The Pirate Bay added');
        })
        .catch(function (error) {
            console.log('[Prowlarr] The Pirate Bay already added');
        });
    // Radarr Api Calls
    ...
    await axios.post('http://' + targetIP + ':' + radarrPort + '/api/v3/downloadclient', radarrAddQbittorrent, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Qbittorrent added');
        })
        .catch(function (error) {
            console.log('[Radarr] Qbittorrent already added');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/1', radarrProfileAny, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile Any modified');
        })
        .catch(function (error) {
            console.log('[Radarr] Profile Any error');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/6', radarrProfileHd7201080, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile 720/1080 modified');
        })
        .catch(function (error) {
            console.log('[Radarr] Profile 720/1080 error');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/4', radarrProfileHd1080, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile 1080 modified');
        })
        .catch(function (error) {
            console.log('[Radarr] Profile 1080 error');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/3', radarrProfileHd720, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile HD 720 modified');
        })
        .catch(function (error) {
            console.log('[Radarr] Profile HD 720 error');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/2', radarrProfileSd, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile sd modified');
        })
        .catch(function (error) {
            console.log('[Radarr] Profile sd error');
        });
    ...
    await axios.put('http://' + targetIP + ':' + radarrPort + '/api/v3/qualityprofile/5', radarrProfileUhd, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Profile UHD modified');
        })
        .catch(function (error) {
    ...
    await axios.post('http://' + targetIP + ':' + radarrPort + '/api/v3/rootFolder', radarrRootFolder, { headers: radarrHeader })
        ...
        .catch(function (error) {
            console.log('[Radarr] Root folder error');
        });
    const radarrVFCustom = { includeCustomFormatWhenRenaming: !1, trash_id: "6d27683346c78d6a3f772e30877910a7", trash_score: "1", trash_regex: "See individual French Audio CFs: VFF, VFI, VOF, VFQ, VQ, VFB", name: "French Audio", specifications: [{ implementation: "LanguageSpecification", implementationName: "Language", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !1, fields: [{ order: 0, name: "value", label: "Language", value: 2, type: "select", advanced: !1, selectOptions: [{ value: -1, name: "Any", order: 0, dividerAfter: !1 }, { value: -2, name: "Original", order: 0, dividerAfter: !1 }, { value: 0, name: "Unknown", order: 0, dividerAfter: !0 }, { value: 31, name: "Arabic", order: 0, dividerAfter: !1 }, { value: 34, name: "Bengali", order: 0, dividerAfter: !1 }, { value: 41, name: "Bosnian", order: 0, dividerAfter: !1 }, { value: 29, name: "Bulgarian", order: 0, dividerAfter: !1 }, { value: 38, name: "Catalan", order: 0, dividerAfter: !1 }, { value: 10, name: "Chinese", order: 0, dividerAfter: !1 }, { value: 39, name: "Croatian", order: 0, dividerAfter: !1 }, { value: 25, name: "Czech", order: 0, dividerAfter: !1 }, { value: 6, name: "Danish", order: 0, dividerAfter: !1 }, { value: 7, name: "Dutch", order: 0, dividerAfter: !1 }, { value: 1, name: "English", order: 0, dividerAfter: !1 }, { value: 42, name: "Estonian", order: 0, dividerAfter: !1 }, { value: 16, name: "Finnish", order: 0, dividerAfter: !1 }, { value: 19, name: "Flemish", order: 0, dividerAfter: !1 }, { value: 2, name: "French", order: 0, dividerAfter: !1 }, { value: 4, name: "German", order: 0, dividerAfter: !1 }, { value: 20, name: "Greek", order: 0, dividerAfter: !1 }, { value: 23, name: "Hebrew", order: 0, dividerAfter: !1 }, { value: 26, name: "Hindi", order: 0, dividerAfter: !1 }, { value: 22, name: "Hungarian", order: 0, dividerAfter: !1 }, { value: 9, name: "Icelandic", order: 0, dividerAfter: !1 }, { value: 44, name: "Indonesian", order: 0, dividerAfter: !1 }, { value: 5, name: "Italian", order: 0, dividerAfter: !1 }, { value: 8, name: "Japanese", order: 0, dividerAfter: !1 }, { value: 21, name: "Korean", order: 0, dividerAfter: !1 }, { value: 36, name: "Latvian", order: 0, dividerAfter: !1 }, { value: 24, name: "Lithuanian", order: 0, dividerAfter: !1 }, { value: 15, name: "Norwegian", order: 0, dividerAfter: !1 }, { value: 33, name: "Persian", order: 0, dividerAfter: !1 }, { value: 12, name: "Polish", order: 0, dividerAfter: !1 }, { value: 18, name: "Portuguese", order: 0, dividerAfter: !1 }, { value: 30, name: "Portuguese (Brazil)", order: 0, dividerAfter: !1 }, { value: 27, name: "Romanian", order: 0, dividerAfter: !1 }, { value: 11, name: "Russian", order: 0, dividerAfter: !1 }, { value: 40, name: "Serbian", order: 0, dividerAfter: !1 }, { value: 35, name: "Slovak", order: 0, dividerAfter: !1 }, { value: 3, name: "Spanish", order: 0, dividerAfter: !1 }, { value: 37, name: "Spanish (Latino)", order: 0, dividerAfter: !1 }, { value: 14, name: "Swedish", order: 0, dividerAfter: !1 }, { value: 43, name: "Tamil", order: 0, dividerAfter: !1 }, { value: 45, name: "Telugu", order: 0, dividerAfter: !1 }, { value: 28, name: "Thai", order: 0, dividerAfter: !1 }, { value: 17, name: "Turkish", order: 0, dividerAfter: !1 }, { value: 32, name: "Ukrainian", order: 0, dividerAfter: !1 }, { value: 13, name: "Vietnamese", order: 0, dividerAfter: !1 }] }], name: "French Language", id: 2 }, { implementation: "ReleaseTitleSpecification", implementationName: "Release Title", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !1, fields: [{ order: 0, name: "value", label: "Regular Expression", helpText: "Custom Format RegEx is Case Insensitive", type: "textbox", advanced: !1, value: "\\bVOF\\b" }], name: "French Original Version", id: 3 }, { implementation: "ReleaseTitleSpecification", implementationName: "Release Title", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !1, fields: [{ order: 0, name: "value", label: "Regular Expression", helpText: "Custom Format RegEx is Case Insensitive", type: "textbox", advanced: !1, value: "\\b(TRUEFRENCH|VFF?)\\b" }], name: "TRUEFRENCH", id: 4 }, { implementation: "ReleaseTitleSpecification", implementationName: "Release Title", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !1, fields: [{ order: 0, name: "value", label: "Regular Expression", helpText: "Custom Format RegEx is Case Insensitive", type: "textbox", advanced: !1, value: "\\bFR(A|ENCH)?\\b" }], name: "FRENCH", id: 5 }, { implementation: "ReleaseTitleSpecification", implementationName: "Release Title", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !1, fields: [{ order: 0, name: "value", label: "Regular Expression", helpText: "Custom Format RegEx is Case Insensitive", type: "textbox", advanced: !1, value: "\\bVF(I|\\d)\\b" }], name: "French International", id: 6 }] };
    await axios.post('http://' + targetIP + ':' + radarrPort + '/api/v3/customformat', radarrVFCustom, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] French Custom Formats added');
        })
        .catch(function (error) {
            console.log('[Radarr] French Custom Formats error');
        });
    const radarrMultiCustom = { includeCustomFormatWhenRenaming: !0, trash_id: "d5f3a1afdb77e6b95e489f7654532d04", name: "Multi-French", specifications: [{ implementation: "ReleaseTitleSpecification", implementationName: "Release Title", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !0, fields: [{ order: 0, name: "value", label: "Regular Expression", helpText: "Custom Format RegEx is Case Insensitive", type: "textbox", advanced: !1, value: "\\b(MULTi)(\\b|\\d)" }], name: "MULTi", id: 2 }, { implementation: "LanguageSpecification", implementationName: "Language", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !0, fields: [{ order: 0, name: "value", label: "Language", value: -2, type: "select", advanced: !1, selectOptions: [{ value: -1, name: "Any", order: 0, dividerAfter: !1 }, { value: -2, name: "Original", order: 0, dividerAfter: !1 }, { value: 0, name: "Unknown", order: 0, dividerAfter: !0 }, { value: 31, name: "Arabic", order: 0, dividerAfter: !1 }, { value: 34, name: "Bengali", order: 0, dividerAfter: !1 }, { value: 41, name: "Bosnian", order: 0, dividerAfter: !1 }, { value: 29, name: "Bulgarian", order: 0, dividerAfter: !1 }, { value: 38, name: "Catalan", order: 0, dividerAfter: !1 }, { value: 10, name: "Chinese", order: 0, dividerAfter: !1 }, { value: 39, name: "Croatian", order: 0, dividerAfter: !1 }, { value: 25, name: "Czech", order: 0, dividerAfter: !1 }, { value: 6, name: "Danish", order: 0, dividerAfter: !1 }, { value: 7, name: "Dutch", order: 0, dividerAfter: !1 }, { value: 1, name: "English", order: 0, dividerAfter: !1 }, { value: 42, name: "Estonian", order: 0, dividerAfter: !1 }, { value: 16, name: "Finnish", order: 0, dividerAfter: !1 }, { value: 19, name: "Flemish", order: 0, dividerAfter: !1 }, { value: 2, name: "French", order: 0, dividerAfter: !1 }, { value: 4, name: "German", order: 0, dividerAfter: !1 }, { value: 20, name: "Greek", order: 0, dividerAfter: !1 }, { value: 23, name: "Hebrew", order: 0, dividerAfter: !1 }, { value: 26, name: "Hindi", order: 0, dividerAfter: !1 }, { value: 22, name: "Hungarian", order: 0, dividerAfter: !1 }, { value: 9, name: "Icelandic", order: 0, dividerAfter: !1 }, { value: 44, name: "Indonesian", order: 0, dividerAfter: !1 }, { value: 5, name: "Italian", order: 0, dividerAfter: !1 }, { value: 8, name: "Japanese", order: 0, dividerAfter: !1 }, { value: 21, name: "Korean", order: 0, dividerAfter: !1 }, { value: 36, name: "Latvian", order: 0, dividerAfter: !1 }, { value: 24, name: "Lithuanian", order: 0, dividerAfter: !1 }, { value: 15, name: "Norwegian", order: 0, dividerAfter: !1 }, { value: 33, name: "Persian", order: 0, dividerAfter: !1 }, { value: 12, name: "Polish", order: 0, dividerAfter: !1 }, { value: 18, name: "Portuguese", order: 0, dividerAfter: !1 }, { value: 30, name: "Portuguese (Brazil)", order: 0, dividerAfter: !1 }, { value: 27, name: "Romanian", order: 0, dividerAfter: !1 }, { value: 11, name: "Russian", order: 0, dividerAfter: !1 }, { value: 40, name: "Serbian", order: 0, dividerAfter: !1 }, { value: 35, name: "Slovak", order: 0, dividerAfter: !1 }, { value: 3, name: "Spanish", order: 0, dividerAfter: !1 }, { value: 37, name: "Spanish (Latino)", order: 0, dividerAfter: !1 }, { value: 14, name: "Swedish", order: 0, dividerAfter: !1 }, { value: 43, name: "Tamil", order: 0, dividerAfter: !1 }, { value: 45, name: "Telugu", order: 0, dividerAfter: !1 }, { value: 28, name: "Thai", order: 0, dividerAfter: !1 }, { value: 17, name: "Turkish", order: 0, dividerAfter: !1 }, { value: 32, name: "Ukrainian", order: 0, dividerAfter: !1 }, { value: 13, name: "Vietnamese", order: 0, dividerAfter: !1 }] }], name: "Original Audio", id: 3 }, { implementation: "LanguageSpecification", implementationName: "Language", infoLink: "https://wiki.servarr.com/radarr/settings#custom-formats-2", negate: !1, required: !0, fields: [{ order: 0, name: "value", label: "Language", value: 2, type: "select", advanced: !1, selectOptions: [{ value: -1, name: "Any", order: 0, dividerAfter: !1 }, { value: -2, name: "Original", order: 0, dividerAfter: !1 }, { value: 0, name: "Unknown", order: 0, dividerAfter: !0 }, { value: 31, name: "Arabic", order: 0, dividerAfter: !1 }, { value: 34, name: "Bengali", order: 0, dividerAfter: !1 }, { value: 41, name: "Bosnian", order: 0, dividerAfter: !1 }, { value: 29, name: "Bulgarian", order: 0, dividerAfter: !1 }, { value: 38, name: "Catalan", order: 0, dividerAfter: !1 }, { value: 10, name: "Chinese", order: 0, dividerAfter: !1 }, { value: 39, name: "Croatian", order: 0, dividerAfter: !1 }, { value: 25, name: "Czech", order: 0, dividerAfter: !1 }, { value: 6, name: "Danish", order: 0, dividerAfter: !1 }, { value: 7, name: "Dutch", order: 0, dividerAfter: !1 }, { value: 1, name: "English", order: 0, dividerAfter: !1 }, { value: 42, name: "Estonian", order: 0, dividerAfter: !1 }, { value: 16, name: "Finnish", order: 0, dividerAfter: !1 }, { value: 19, name: "Flemish", order: 0, dividerAfter: !1 }, { value: 2, name: "French", order: 0, dividerAfter: !1 }, { value: 4, name: "German", order: 0, dividerAfter: !1 }, { value: 20, name: "Greek", order: 0, dividerAfter: !1 }, { value: 23, name: "Hebrew", order: 0, dividerAfter: !1 }, { value: 26, name: "Hindi", order: 0, dividerAfter: !1 }, { value: 22, name: "Hungarian", order: 0, dividerAfter: !1 }, { value: 9, name: "Icelandic", order: 0, dividerAfter: !1 }, { value: 44, name: "Indonesian", order: 0, dividerAfter: !1 }, { value: 5, name: "Italian", order: 0, dividerAfter: !1 }, { value: 8, name: "Japanese", order: 0, dividerAfter: !1 }, { value: 21, name: "Korean", order: 0, dividerAfter: !1 }, { value: 36, name: "Latvian", order: 0, dividerAfter: !1 }, { value: 24, name: "Lithuanian", order: 0, dividerAfter: !1 }, { value: 15, name: "Norwegian", order: 0, dividerAfter: !1 }, { value: 33, name: "Persian", order: 0, dividerAfter: !1 }, { value: 12, name: "Polish", order: 0, dividerAfter: !1 }, { value: 18, name: "Portuguese", order: 0, dividerAfter: !1 }, { value: 30, name: "Portuguese (Brazil)", order: 0, dividerAfter: !1 }, { value: 27, name: "Romanian", order: 0, dividerAfter: !1 }, { value: 11, name: "Russian", order: 0, dividerAfter: !1 }, { value: 40, name: "Serbian", order: 0, dividerAfter: !1 }, { value: 35, name: "Slovak", order: 0, dividerAfter: !1 }, { value: 3, name: "Spanish", order: 0, dividerAfter: !1 }, { value: 37, name: "Spanish (Latino)", order: 0, dividerAfter: !1 }, { value: 14, name: "Swedish", order: 0, dividerAfter: !1 }, { value: 43, name: "Tamil", order: 0, dividerAfter: !1 }, { value: 45, name: "Telugu", order: 0, dividerAfter: !1 }, { value: 28, name: "Thai", order: 0, dividerAfter: !1 }, { value: 17, name: "Turkish", order: 0, dividerAfter: !1 }, { value: 32, name: "Ukrainian", order: 0, dividerAfter: !1 }, { value: 13, name: "Vietnamese", order: 0, dividerAfter: !1 }] }], name: "French Audio", id: 4 }] };
    await axios.post('http://' + targetIP + ':' + radarrPort + '/api/v3/customformat', radarrMultiCustom, { headers: radarrHeader })
        .then(function (response) {
            console.log('[Radarr] Custom Formats added');
        })
        .catch(function (error) {
    ...
    await axios.post('http://' + targetIP + ':' + sonarrPort + '/api/v3/downloadclient', sonarrAddQbittorrent, { headers: sonarrHeader })
        ...
        .catch(function (error) {
            console.log('[Sonarr] Qbittorrent error');
        });
    await axios.delete('http://' + targetIP + ':' + sonarrPort + '/api/v3/languageprofile/1', { headers: sonarrHeader })
        .then(function (response) {
            console.log('[Sonarr] Profile English deleted');
        })
        .catch(function (error) {
            console.log('[Sonarr] Profile English error');
        });
    ...
    await axios.post('http://' + targetIP + ':' + sonarrPort + '/api/v3/languageprofile', sonarrAddLanguageProfile, { headers: sonarrHeader })
        .then(function (response) {
            console.log('[Sonarr] Profile French added');
        })
        .catch(function (error) {
            console.log('[Sonarr] Profile French error');
        });
    ...
    await axios.post('http://' + targetIP + ':' + sonarrPort + '/api/v3/releaseprofile', sonarrCustomProfile, { headers: sonarrHeader })
        .then(function (response) {
            console.log('[Sonarr] Custom Profile added');
        })
        .catch(function (error) {
    ...
    await axios.post('http://' + targetIP + ':' + sonarrPort + '/api/v3/rootfolder', sonarrRootFolder, { headers: sonarrHeader })
        ...
        .catch(function (error) {
            console.log('[Sonarr] Root Folder error');
        });
    ...
    await jellyfinPage.waitForSelector('#wizardSettingsPage > div > div > form > div.wizardNavigation > button.raised.button-submit.emby-button');
    const elements = await jellyfinPage.$$("#wizardSettingsPage>div>div>form>div.wizardNavigation>button.raised.button-submit.emby-button"); if (elements.length > 1) { await elements[1].click(); } else { console.log("Deuxième élément non trouvé."); }
    ...
    // for (const button of setupbuttons2) { const buttonText = await jellyseerr.evaluate(button => button.innerText, button); console.log("Find"); }
    ...
    await axios.post('http://' + targetIP + ':' + jellyseerrPort + '/api/v1/settings/sonarr', jellyseerrAddSonarr, { headers: { 'x-api-key': jellyseerrApiKey } })
        ...
        .catch(function (error) {
            console.log('[Jellyseer] Erreur lors de l\'ajout de Sonarr');
        });
