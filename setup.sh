...
if [ "$autosetup" = true ] ; then
    ...
    # Start jackett.js
    sudo -u media node /home/media/seedflix/autosetup/jackett.js && \
    sudo -u media node /home/media/seedflix/autosetup/radarr.js && \
    sudo -u media node /home/media/seedflix/autosetup/sonarr.js && \
    sudo -u media node /home/media/seedflix/autosetup/qbittorrent.js
